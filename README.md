...
- `npm run test:e2e`: passed across onboarding, all six lesson exercise types, lesson completion, chat, adaptive practice, Story Mode quiz, Bangalore Mode, profile, model setup controls, and live Ollama smoke with `qwen2.5:0.5b`.
