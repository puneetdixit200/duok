...
const baseSurvivalExercises: LessonExercise[] = [
  ...
  },
  {
    ...
    explanation: 'ಧನ್ಯವಾದ means thank you after help, service, or a kind gesture.',
    skillTag: 'greetings',
    xp: 2,
  ...
  },
  {
    ...
    explanation: 'ನಮಸ್ಕಾರ ಸಾರ್ is the polite greeting you heard.',
    skillTag: 'listening',
    xp: 3,
    vocabularyIds: ['namaskara-saar'],
  },
  {
    ...
    options: ['ನಮಸ್ಕಾರ', 'ಧನ್ಯವಾದ', 'ಹೋಗಿ ಬನ್ನಿ', 'ಬಾ', 'Hello', 'Thank you', 'Goodbye', 'Come'],
    explanation: 'These are the first useful greeting and goodbye pairs.',
    skillTag: 'vocabulary',
    xp: 4,
  ...
  },
  {
    ...
    kannada: 'ನಮಸ್ಕಾರ ಸಾರ್ ಧನ್ಯವಾದ',
    answer: 'ನಮಸ್ಕಾರ ಸಾರ್ ಧನ್ಯವಾದ',
    options: ['ಧನ್ಯವಾದ', 'ಸಾರ್', 'ನಮಸ್ಕಾರ', 'ಬೇಕು'],
    explanation: 'ನಮಸ್ಕಾರ ಸಾರ್ ಧನ್ಯವಾದ keeps the polite greeting before thanks.',
    skillTag: 'greetings',
    xp: 3,
    vocabularyIds: ['namaskara-saar', 'dhanyavada'],
  },
